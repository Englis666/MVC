                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?=$r->pro_img?></td>
                      <td><?=$r->pro_can?></td>
                      <td><a href="?c=producto&a=FormCrear&id=<?=$r->pro_id?>" class="btn btn-info btn-flat"><i class="fa fa-lg fa-refresh"></i></a> 
                        <a href="?c=producto&a=Borrar&id=<?=$r->pro_id?>" class="btn btn-warning btn-flat"><i class="fa fa-lg fa-trash"></i></a>
                      </td>
                    </td>
                    </tr>
                    <?php endforeach; ?>
